...
if uploaded_file:
    try:
        ...
        # STR için Add_To_Card'ı yeniden adlandır
        ...
        def performans_ozeti(row):
            ...
            post = f"✨ Yeni trend alarmı! {urun_adi} bu hafta satış ve ilgide zirveye oynuyor. Sen de kaçırma! 🔥 #trendurun #stil #yenisezon"
