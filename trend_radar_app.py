...
if uploaded_file:
    try:
        ...
        # ✅ Z Skorlarını hesapla (kategoriye göre)
        z_df_list = []
        for kategori in df["Kategori"].unique():
            ...
            # Final Trend Skoru: 0.7 lokal metrikler + 0.3 Google Trends
            sub_df["Trend_Skoru"] = (
        ...
        grafik = alt.Chart(secilen_df).mark_bar().encode(
            ...
            tooltip=["UrUn_Kodu", "Trend_Skoru", "Z_Google"]
        ...
        for _, row in trend_urunler.iterrows():
            with st.container():
                ...
                with cols[1]:
                    ...
                    with st.expander("📣 Sosyal Medya İçin Paylaşım Önerisi"):
...
def sosyal_medya_postu(row):
    ...
    return (
        ...
        f"📣 Instagram Post Önerisi:\n"
        f"{etiket} trend oldu! {vurucu}\n"
