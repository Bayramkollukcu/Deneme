...
if uploaded_file:
    ...
    # Devir Hızı yeniden hesaplanıyor (eğer güncel değilse)
    ...
    # Trend ürünler (skor ≥ eşiği ve kategoriye göre)
    ...
    st.info("Lütfen bir .xlsx veri dosyası yükleyin.")
